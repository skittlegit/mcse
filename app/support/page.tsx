...
const faqs = [
  ...
  { q: "What's the difference between MARKET and LIMIT orders?", a: "MARKET orders fill instantly at the current market price. LIMIT orders let you set a max buy / min sell price — they fill instantly if marketable, or wait in the order book until the price reaches your limit (auto-expire after ~30 min if unfilled)." },
