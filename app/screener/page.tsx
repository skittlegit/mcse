        ...
        <div>
          <div className="hidden md:block">
            <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_60px] gap-2 px-4 py-2 border-b border-white/8 text-[9px] tracking-[0.15em] text-[#666]">
              <button onClick={() => toggleSort("ticker")} className="flex items-center gap-1 text-left hover:text-white transition-colors">TICKER <SortIcon k="ticker" /></button>
              <button onClick={() => toggleSort("price")} className="flex items-center gap-1 text-right justify-end hover:text-white transition-colors">PRICE <SortIcon k="price" /></button>
              <button onClick={() => toggleSort("change")} className="flex items-center gap-1 text-right justify-end hover:text-white transition-colors">CHG% <SortIcon k="change" /></button>
              <button onClick={() => toggleSort("volume")} className="flex items-center gap-1 text-right justify-end hover:text-white transition-colors">VOL <SortIcon k="volume" /></button>
              <button onClick={() => toggleSort("pe")} className="flex items-center gap-1 text-right justify-end hover:text-white transition-colors">P/E <SortIcon k="pe" /></button>
              <span />
            </div>
            {filtered.map((s) => (
